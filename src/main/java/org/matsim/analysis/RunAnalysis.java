...
public class RunAnalysis {
    ...
    private static void printAverageDistance(Map<Id<Person>, List<Double>> tripsByPerson) {
        ...
        var averageDistanceTravelled = tripsByPerson.values().stream()
                ...
                .flatMap(Collection::stream)
                // map the Boxed Double value to a primitive double value -> this is very java specific you can google java boxed primitives if you want to know what's going on
